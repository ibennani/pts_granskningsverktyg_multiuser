export default {
  ...
  moduleNameMapper: {
    ...
    '^.+[\\\\/]llm_chat_timeout\\.js$': '<rootDir>/server/services/llm_chat_timeout.ts',
    '^.+[\\\\/]llm_ollama_chat_stream\\.js$': '<rootDir>/server/services/llm_ollama_chat_stream.ts',
    '^.+[\\\\/]abort_signal_merge\\.js$': '<rootDir>/server/services/abort_signal_merge.ts',
    '^.+[\\\\/]llm_ollama_agent\\.js$': '<rootDir>/server/services/llm_ollama_agent.ts',
    '^.+[\\\\/]llm_chat_tools_schema\\.js$': '<rootDir>/server/services/llm_chat_tools_schema.ts',
    '^.+[\\\\/]llm_chat_system_prompt\\.js$': '<rootDir>/server/services/llm_chat_system_prompt.ts',
    '^.+[\\\\/]llm_chat_domain_context\\.js$': '<rootDir>/server/services/llm_chat_domain_context.ts',
    '^.+[\\\\/]llm_chat_log\\.js$': '<rootDir>/server/services/llm_chat_log.ts',
    '^.+[\\\\/]llm_tool_context\\.js$': '<rootDir>/server/services/llm_tool_context.ts',
    '^.+[\\\\/]llm_tool_executor\\.js$': '<rootDir>/server/services/llm_tool_executor.ts',
    '^.+[\\\\/]llm_tool_read_handlers\\.js$': '<rootDir>/server/services/llm_tool_read_handlers.ts',
    '^.+[\\\\/]llm_tool_write_handlers\\.js$': '<rootDir>/server/services/llm_tool_write_handlers.ts',
    '^.+[\\\\/]llm_tool_summaries\\.js$': '<rootDir>/server/services/llm_tool_summaries.ts',
    '^.+[\\\\/]llm_tool_audit_list_compact\\.js$': '<rootDir>/server/services/llm_tool_audit_list_compact.ts',
    '^.+[\\\\/]llm_tool_rule_requirements\\.js$': '<rootDir>/server/services/llm_tool_rule_requirements.ts',
    '^.+[\\\\/]llm_tool_audit_content\\.js$': '<rootDir>/server/services/llm_tool_audit_content.ts',
    '^.+[\\\\/]routes/audit_index_row_mapper\\.js$': '<rootDir>/server/routes/audit_index_row_mapper.ts',
  },
  testMatch: [
