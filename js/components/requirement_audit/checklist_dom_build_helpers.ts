...
export function create_pass_criterion_title_h4(
    ...
    sync_pass_criterion_deficiency_id_on_title(
        host, pc_title_h4, audit_frozen, current_pc_status, pc_data.deficiencyId
    );
    set_pass_criterion_title_aria_label(
        host, pc_title_h4, criterion_title, pc_status_text, audit_frozen, current_pc_status, pc_data.deficiencyId
    );
    return pc_title_h4;
}
