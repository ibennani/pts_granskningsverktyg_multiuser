...
/** Print-CSS som speglar Word-exportens Calibri, rubrikstorlekar och mellanrum. */
export function build_report_pdf_print_css(): string {
    const font_stack = `'${REPORT_EXPORT_FONT_FAMILY}', 'Segoe UI', Arial, sans-serif`;
...
h2 { font-size: ${heading2}pt; margin: ${heading_before}pt 0 ${heading_after}pt; page-break-before: always; }
h3 { font-size: ${heading3}pt; margin: ${heading_before}pt 0 ${heading_after}pt; }
