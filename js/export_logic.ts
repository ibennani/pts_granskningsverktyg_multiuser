...
import { export_to_word_criterias, export_to_word_samples, export_to_word_deficiency_types, export_to_word_screenshots_appendix } from './export/export_word_main_flow.js';
