...
import { export_to_word_criterias, export_to_word_samples, export_to_word_appendix1_summary, export_to_word_screenshots_appendix, export_observation_texts_word } from './export/export_word_main_flow.js';
...
import { export_audit_appendices_zip } from './export/export_audit_appendices_zip.js';
import { export_to_pdf_criterias, export_to_pdf_samples, export_to_pdf_appendix1_summary, export_to_pdf_screenshots_appendix } from './export/export_pdf_main_flow.js';
...
export const public_api = {
    ...
    export_to_word_appendix1_summary: wrap_export_first_arg(export_to_word_appendix1_summary as (audit: unknown, ...rest: unknown[]) => unknown),
    export_to_word_deficiency_types: wrap_export_first_arg(export_to_word_appendix1_summary as (audit: unknown, ...rest: unknown[]) => unknown),
    ...
    export_audit_appendices_zip: wrap_export_first_arg(export_audit_appendices_zip as (audit: unknown, ...rest: unknown[]) => unknown),
    ...
    export_to_pdf_appendix1_summary: wrap_export_first_arg(export_to_pdf_appendix1_summary as (audit: unknown, ...rest: unknown[]) => unknown),
    export_to_pdf_deficiency_types: wrap_export_first_arg(export_to_pdf_appendix1_summary as (audit: unknown, ...rest: unknown[]) => unknown),
