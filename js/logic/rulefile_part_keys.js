// js/logic/rulefile_part_keys.js
//
// Stabilt nyckelformat för del-sparning och fältlås i regelfilsredigering.
// Nycklarna ska vara stabila över tid och kunna tolkas både i klient och server.
//
// Format (v1):
// - metadata
// - reportTemplate
...
//
// Obs: requirement_key är samma nyckel som används i ruleFileContent.requirements (inte requirement.id).
