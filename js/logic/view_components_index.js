...
import { AiChatViewComponent } from '../components/AiChatViewComponent.ts';
...
const aiChatViewComponent = new AiChatViewComponent();
...
export function get_component_class(view_name) {
    switch (view_name) {
        ...
        case 'ai_chat': return aiChatViewComponent;
