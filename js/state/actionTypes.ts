// js/state/actionTypes.ts

export const ActionTypes = {
    INITIALIZE_NEW_AUDIT: 'INITIALIZE_NEW_AUDIT',
    UPDATE_NEW_AUDIT_RULEFILE: 'UPDATE_NEW_AUDIT_RULEFILE',
    ...
    MARK_ALL_UNREVIEWED_AS_PASSED_IN_SAMPLE: 'MARK_ALL_UNREVIEWED_AS_PASSED_IN_SAMPLE',
    ...
    UPDATE_USER_REQUIREMENT_RESUME: 'UPDATE_USER_REQUIREMENT_RESUME',
    APPLY_OBSERVATION_WORD_IMPORT: 'APPLY_OBSERVATION_WORD_IMPORT'
};
