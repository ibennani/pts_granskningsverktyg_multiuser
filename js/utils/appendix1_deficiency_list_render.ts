/**
 * @fileoverview Delad rendering av punktlistor med bristtyper för Bilaga 1 (samma som export).
 */
...
/**
 * Lägger till punktlista med bristtyper under en 3.x-sektion i visningsläge.
 */
export function append_deficiency_types_list_dom(
    ...
    const list = deps.create_element('ul');
    for (const entry of types) {
