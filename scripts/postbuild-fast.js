...
console.info('[postbuild-fast] Starting...');
...
console.info('[postbuild-fast] Copying CSS files...');
...
if (existsSync(cssSourcePath)) {
  try {
    ...
    console.info('[postbuild-fast] Successfully copied CSS files');
  } catch (error) {
...
`;
  ...
  console.info('[postbuild-fast] Generated build-info.js');
  ...
  if (existsSync(indexPath)) {
    ...
    console.info('[postbuild-fast] Injected build timestamp into index.html');
  }
} catch (error) {
...
console.info('[postbuild-fast] Completed successfully');
