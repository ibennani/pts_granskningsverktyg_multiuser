...
async function migrate() {
    ...
    try {
        ...
        console.info('[Migrate] Migration 010 kördes.');
        ...
        console.info('[Migrate] Migration 016 kördes.');
        const sql17 = readFileSync(join(__dirname, '../migrations/017_add_rule_edit_locks.sql'), 'utf8');
        await client.query(sql17);
        console.info('[Migrate] Migration 017 kördes.');
