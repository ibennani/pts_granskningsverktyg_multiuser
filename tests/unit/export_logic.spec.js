...
jest.unstable_mockModule('docx', () => ({
    ...
    Bookmark: jest.fn(),
    PageReference: jest.fn(),
    PositionalTab: jest.fn(),
...
describe('ExportLogic - Word Export', () => {
    ...
    describe('export_to_word_criterias', () => {
        ...
        test('should include observation section', async () => {
            ...
            // When sorting by requirements, observations come directly after "Granskningsdelar:" heading
            expect(allText).toContain('Granskningsdelar:');
