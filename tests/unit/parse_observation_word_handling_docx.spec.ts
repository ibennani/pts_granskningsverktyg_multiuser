...
describe('parse_observation_word_handling_docx', () => {
    ...
    test('avkodar XML-entiteter i w:t', () => {
    ...
    <w:tbl>
      <w:tr>
        <w:tc>
          ...
          <w:p>
            <w:pPr><w:pStyle w:val="Heading4"/></w:pPr>
            <w:r><w:t>Brist-id 5</w:t></w:r>
          </w:p>
          <w:p>
            <w:r><w:t>AT&amp;T och A &amp; B</w:t></w:r>
          </w:p>
        </w:tc>
      </w:tr>
    </w:tbl>
        ...
        expect(blocks).toHaveLength(1);
        expect(blocks[0].observation_markdown).toBe('AT&T och A & B');
    });

    test('sammanfogar text split på flera w:r', () => {
        const document_xml = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:body>
    <w:tbl>
