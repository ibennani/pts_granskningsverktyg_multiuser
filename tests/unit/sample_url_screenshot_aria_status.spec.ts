...
describe('sample_url_screenshot_aria_status', () => {
    test('set_sample_url_screenshot_live_status sätter översatt text i live-region', () => {
        ...
        expect(find_url_screenshot_live_region(btn)?.textContent).toBe('Tar skärmavbild');
    });
